...
// v2: add tags to expenses, budgetLimit to categories, recurringExpenses table
db.version(2)
  .stores({
    contexts: "++id, name, isArchived",
  ...
  .upgrade((tx) => {
    // Add tags array to existing expenses
    return tx
      .table("expenses")
      .toCollection()
      .modify((exp) => {
...
export const DEFAULT_CATEGORIES = [
  ...
  },
  {
    ...
    icon: "🏠",
    color: "#8b5cf6",
    keywords: ["rent", "housing", "apartment"],
  },
  {
    name: "Transport",
    icon: "🚗",
    color: "#3b82f6",
    keywords: ["uber", "ola", "metro", "bus", "fuel", "petrol", "taxi", "auto"],
  },
  {
    name: "Shopping",
    icon: "🛒",
    color: "#f59e0b",
    keywords: ["amazon", "flipkart", "shopping", "clothes"],
  },
  {
    name: "Utilities",
    icon: "💡",
  ...
  },
  {
    ...
    icon: "🎬",
    color: "#ec4899",
    keywords: ["netflix", "movie", "spotify", "subscription", "game"],
  },
  {
    name: "Health",
    icon: "🏥",
    color: "#14b8a6",
    keywords: ["medicine", "doctor", "hospital", "pharmacy", "gym", "health"],
  },
  {
    name: "Education",
    icon: "📚",
    color: "#6366f1",
    keywords: ["course", "book", "udemy", "learning"],
  },
  {
    name: "Travel",
    icon: "✈️",
    color: "#0ea5e9",
    keywords: ["flight", "hotel", "trip", "travel", "vacation"],
  },
  {
    name: "Savings",
    icon: "💰",
    color: "#22c55e",
    keywords: ["invest", "mutual fund", "sip", "fd", "savings"],
  },
...
export const DEFAULT_EXPENSES_TEMPLATE = [
  { category: "Rent", amount: 15000, note: "Monthly rent", isRecurring: true },
  {
    category: "Food",
    amount: 6000,
    note: "Groceries & cooking",
    isRecurring: true,
  },
  {
    category: "Food",
    amount: 3000,
    note: "Eating out & ordering",
    isRecurring: false,
  },
  {
    category: "Transport",
    amount: 2500,
    note: "Daily commute (metro/bus/auto)",
    isRecurring: true,
  },
  {
    category: "Utilities",
  ...
  },
  {
    category: "Shopping",
    amount: 2000,
    note: "Essentials & personal care",
    isRecurring: false,
  },
  {
    category: "Savings",
    amount: 5000,
    note: "SIP / Mutual funds",
    isRecurring: true,
  },
];
